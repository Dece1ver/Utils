            ...
            if (AllocConsole())
            {
                ...
                while (true)
                {
                    ...
                    if (output is ConsoleKey.D3 or ConsoleKey.NumPad3)
                    {
                        ...
                        Console.WriteLine("Использование программы подразумевается вызовом через контекстное меню по переменовываемым файлам. (ПКМ)\n" +
                            "Работа программы проиходит без каких либо уведомлений.\n" +
